...
function Build64Deluge {
    ...
    Move-Item –Path "C:\deluge-deluge-2.0.5\packaging\win32\freeze\Deluge\deluge" -Destination "C:\deluge-deluge-2.0.5\packaging\win32\freeze\Deluge\deluge-2.0.5.EGG_INFO"
